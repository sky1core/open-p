...
// Both waits are upper bounds, not delays: they return on the first satisfied poll, so the happy
// path pays nothing. Keep them generous — the CLI under test boots through tsx, and a loaded
// machine has pushed that boot past three seconds.
